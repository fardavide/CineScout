...
object ScreenplaySample {
    ...
    val BreakingBad = TvShow(
        backdropImage = ScreenplayImagesSample.BreakingBad.backdrops.firstOrNone(),
        ...
        posterImage = ScreenplayImagesSample.BreakingBad.posters.firstOrNone(),
        rating = PublicRating(voteCount = 10_125, average = Rating.of(8.839).getOrThrow()),
        title = "Breaking Bad",
        tmdbId = TmdbScreenplayIdSample.BreakingBad
    )
    val Dexter = TvShow(
        backdropImage = ScreenplayImagesSample.Dexter.backdrops.firstOrNone(),
        ...
        posterImage = ScreenplayImagesSample.Dexter.posters.firstOrNone(),
        rating = PublicRating(voteCount = 3_233, average = Rating.of(8.191).getOrThrow()),
        title = "Dexter",
        tmdbId = TmdbScreenplayIdSample.Dexter
    )
    val Grimm = TvShow(
        backdropImage = ScreenplayImagesSample.Grimm.backdrops.firstOrNone(),
        ...
        posterImage = ScreenplayImagesSample.Grimm.posters.firstOrNone(),
