...
fun DatabaseTraktAuthState.toAuthState(): TraktAuthState =
    when (state) {
...
fun TraktAuthState.toDatabaseTraktAuthStateValue(): DatabaseTraktAuthStateValue =
    when (this) {
...
fun TraktAuthState.findDatabaseAccessToken(): DatabaseTraktAccessToken? =
    when (this) {
...
fun TraktAuthState.findDatabaseAuthorizationCode(): DatabaseTraktAuthorizationCode? =
    when (this) {
        TraktAuthState.Idle -> null
        is TraktAuthState.AppAuthorized -> code.toDatabaseAuthorizationCode()
        is TraktAuthState.Completed -> null
    }
fun TraktAuthState.findDatabaseRefreshToken(): DatabaseTraktRefreshToken? =
    when (this) {
        TraktAuthState.Idle -> null
        is TraktAuthState.AppAuthorized -> null
