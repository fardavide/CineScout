...
@Composable
internal fun ForYouTvShowItemLayout(
    ...
    Adaptive { windowSizeClass ->
        when (windowSizeClass.width) {
            WindowWidthSizeClass.Compact -> ForYouTvShowItemLayout.Vertical(
            ...
            WindowWidthSizeClass.Medium -> ForYouTvShowItemLayout.Vertical(
            ...
            WindowWidthSizeClass.Expanded -> when (windowSizeClass.height) {
                ...
                WindowHeightSizeClass.Medium -> ForYouTvShowItemLayout.Horizontal(
                    backdrop = backdrop,
                    poster = poster,
                    infoBox = infoBox,
                    genres = genres,
                ...
                WindowHeightSizeClass.Expanded -> ForYouTvShowItemLayout.Vertical(
...
private fun ForYouTvShowItemLayoutPreview() {
    CineScoutTheme {
