...
class TmdbTvShowImagesMapper {
    ...
    private fun toBackdrop(poster: GetTvShowImages.Response.Backdrop) =
        TmdbBackdropImage(path = poster.path)

    private fun toPoster(poster: GetTvShowImages.Response.Poster) =
